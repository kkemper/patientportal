...
class BillingsControllerTest < ActionController::TestCase
  ...
  test "should create billing" do
    assert_difference('Billing.count') do
      post :create, billing: { Date: @billing.Date, Hospital: @billing.Hospital, Reason: @billing.Reason, Status: @billing.Status }
    end
  ...
  test "should update billing" do
    patch :update, id: @billing, billing: { Date: @billing.Date, Hospital: @billing.Hospital, Reason: @billing.Reason, Status: @billing.Status }
    assert_redirected_to billing_path(assigns(:billing))
  end
