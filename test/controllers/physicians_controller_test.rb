...
class PhysiciansControllerTest < ActionController::TestCase
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post :create, physician: { Speciality: @physician.Speciality, hospital: @physician.hospital, name: @physician.name }
    end
  ...
  test "should update physician" do
    patch :update, id: @physician, physician: { Speciality: @physician.Speciality, hospital: @physician.hospital, name: @physician.name }
    assert_redirected_to physician_path(assigns(:physician))
  end
